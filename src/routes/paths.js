...
export const paths = {
  ...
  dashboard: {
    ...
    account: {
      ...
      billing: `${ROOTS.DASHBOARD}/account?tab=billing`,
      notifications: `${ROOTS.DASHBOARD}/account?tab=notifications`,
      socialLink: `${ROOTS.DASHBOARD}/account?tab=social-links`,
      security: `${ROOTS.DASHBOARD}/account?tab=security`,
    },
    group: {
